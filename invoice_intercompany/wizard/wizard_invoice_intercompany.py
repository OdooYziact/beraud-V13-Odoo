        ...
        for company_id in companies:
            ...
            if lines:
                ...
                if is_sale_invoice_created and is_purchase_invoice_created:
                    ...
                    is_sale_invoice_created.write({'account_analytic_line_ids': [(6, False, sale_invoice_line.ids)]})
                    is_purchase_invoice_created.write({'account_analytic_line_ids': [(6, False, purchase_invoice_line.ids)]})
